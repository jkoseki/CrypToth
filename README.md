...
To run CrypToth, exprprea (https://github.com/keisuke-yanagisawa/exprorer_msmd), cosmdanalyzer (in this repository) and DASI (https://github.com/jkoseki/DAIS) must be installed. 
